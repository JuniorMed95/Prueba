const RADIO_NAME = 'Stereo JM';

// Change Stream URL Here, Supports, ICECAST, ZENO, SHOUTCAST, RADIOJAR and any other stream service.
const URL_STREAMING = 'https://stream.zeno.fm/sgyqj3qg4xivv';
...
// For example, if the mount point is 'sgyqj3qg4xivv/source',
// the API link will be 'https://api.zeno.fm/mounts/metadata/subscribe/sgyqj3qg4xivv'.

const url = 'https://api.zeno.fm/mounts/metadata/subscribe/sgyqj3qg4xivv';
...
// Variável global para armazenar o histórico das seis últimas músicas
var musicHistory = [];

// Função para atualizar o histórico das seis últimas músicas
function updateMusicHistory(artist, song) {
    ...
    // Manter apenas as seis últimas músicas no histórico
...
function displayHistory() {
    ...
    // Exibir as seis últimas músicas no histórico, começando do índice 1 para excluir a música atual
    for (var i = 1; i < musicHistory.length && i < 7; i++) {
